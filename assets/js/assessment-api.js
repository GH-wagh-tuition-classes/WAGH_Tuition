...
const WTC_ASSESSMENT_API = (() => {
  ...
  return {
    ...
    importStaticContent: importData => call({ action:'importStaticContent', importData, uploadedBy:'Admin' }),
    publishStaticImport: uploadId => call({ action:'publishStaticImport', uploadId, approvedBy:'Admin' }),
    reviewContent: uploadId => call({ action:'reviewContent', uploadId, reviewedBy:'Admin' }),
    publishContent: uploadId => call({ action:'publishContent', uploadId, approvedBy:'Admin' }),
